...
{
    public partial class HabilitadorGenerico : UserControl
    {
        private string nome;
        ...
        public HabilitadorGenerico()
        {
            InitializeComponent();
            nome = "Habilitador Genérico";
        }
        ...
        private void lblHabGenerico_Click(object sender, EventArgs e)
        {
            CarregarNivel(0);
            valor = 0;
        }
